...
def fetch_hh_vacancies():
    ...
    for language in languages:
        ...
        while True:
            ...
            vacancies[language]['vacancies_found'] = response.json()['found']
        ...
        vacancies[language]['vacancies_processed'] = vacancies_processed
        vacancies[language]['average_salary'] = int(average_salary)
